...
function NavBar(props) {
  ...
  const value12 = {
    ...
    return (<Router>
        <div>
                <>
                <NabBar2 type={type} islogged={islogged} setIsadmin={setIsadmin} isadmin={isadmin} user3={user3} user2={user2} logout={logout} userid={userid} />
                <br></br>
                <div className="auth-wrapper">
                  <div className="auth-inner">
                    ...
                    <UserContext.Provider value={ value12 }>
                      ...
                      <Route path="/sign-in" >
                        <LoginForm setType={setType} setFavs={setFavs} setCart={setCart} setFollowing={setFollowing} setEmail2={setEmail2} setUserid={setUserid} setIslogged={setIslogged} setUser2={setUser2} user2={user2}/>
                        </Route>
